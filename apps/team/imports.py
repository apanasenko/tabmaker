...
class TeamImportForm(forms.Form):
    ...
    team_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'b-form-item__input_full', 'placeholder': 'Скопируйте текст c названием колонки из ячейки таблицы'}), label=MSG_TEAM_NAME)

    speaker_1_email = forms.CharField(widget=forms.TextInput(attrs={'class': 'b-form-item__input_full', 'placeholder': 'Скопируйте текст c названием колонки из ячейки таблицы'}), label=MSG_S1_EMAIL)
    speaker_1_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'b-form-item__input_full', 'placeholder': 'Скопируйте текст c названием колонки из ячейки таблицы'}), label=MSG_S1_NAME)

    speaker_2_email = forms.CharField(widget=forms.TextInput(attrs={'class': 'b-form-item__input_full', 'placeholder': 'Скопируйте текст c названием колонки из ячейки таблицы'}), label=MSG_S2_EMAIL)
    speaker_2_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'b-form-item__input_full', 'placeholder': 'Скопируйте текст c названием колонки из ячейки таблицы'}), label=MSG_S2_NAME)
